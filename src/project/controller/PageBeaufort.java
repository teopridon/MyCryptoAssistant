        ...
        try{
            ...
            if (!(message.matches("[a-zA-Z ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[a-zA-Z ]+$"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageBeaufortEncryption.fxml"));
                    Parent root = loader.load();

                    PageBeaufortEncryption pageBeaufortEncryption = loader.getController();
                    pageBeaufortEncryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("Beaufort Cipher Encryption");
        ...
        try {
            ...
            if (!(message.matches("[a-zA-Z ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[a-zA-Z ]+$"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageBeaufortDecryption.fxml"));
                    Parent root = loader.load();

                    PageBeaufortDecryption pageBeaufortDecryption = loader.getController();
                    pageBeaufortDecryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("Beaufort Cipher Decryption");
                    primaryStage.setScene(scene);
                    primaryStage.show();
                }
            }
