        ...
        try{
            ...
            if (!(message.matches("[a-zA-Z ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[a-zA-Z ]+$"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageVigenereEncryption.fxml"));
                    Parent root = loader.load();

                    PageVigenereEncryption pageVigenereEncryption = loader.getController();
                    pageVigenereEncryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("Vigenere Cipher Encryption");
        ...
        try {
            ...
            if (!(message.matches("[a-zA-Z ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[a-zA-Z ]+$"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageVigenereDecryption.fxml"));
                    Parent root = loader.load();

                    PageVigenereDecryption pageVigenereDecryption = loader.getController();
                    pageVigenereDecryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("Vigenere Cipher Decryption");
                    primaryStage.setScene(scene);
                    primaryStage.show();
                }
            }
