...
public class PageDESEncryption {
    ...
    public void Encrypt(){
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ------------------------STEP II: ENCODE EACH 64-BIT BLOCK OF DATA-----------------------------------"));
        step2();
    }
    ...
    public void step2() {
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Step 5: We apply the initial permutation to the message in binary."));
        showMessageBase2();
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Step 6: Next divide the permuted block IP message into a left half L0 of 32 bits, and a right half R0 of 32 bits."));
        getL0R0();

        getAllLnRn();

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Step 8: We have the blocks L16 and R16. We reverse the order of the two blocks into the 64-bit block R16L16"));
        getR16L16();

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Step 9: Apply a final permutation IP-1 as defined by the following table:"));
    ...
    public void writeIPminus1ToHexa(){
        result = "";
        String[] strings = new String[16];

        int k=0;
        for (int i = 0; i < iPminus1.length; i=i+4) {
            strings[k] = String.valueOf(iPminus1[i]) + String.valueOf(iPminus1[i+1]) + String.valueOf(iPminus1[i+2]) + String.valueOf(iPminus1[i+3]);
            k++;
        }
    ...
    public void printResult(){
        ...
        vBox.getChildren().add(new Label(""));
        String line = " The encrypted message is: " + result;
    ...
    public void getIPminus1(){

        int k = 0;
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
                iPminus1[k] = r16l16[matrixIPminus1[i][j]-1];
                k++;
            }
        }
    ...
    public void getR16L16(){

        r16l16 = new char[64];

        System.arraycopy(r16, 0, r16l16, 0, 32);
        System.arraycopy(l16, 0, r16l16, 32, 32);
    ...
    public void getAllLnRn() {
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 1 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L1 = R0"));
        vBox.getChildren().add(new Label(" L1 is: "));
        l1 = r0;
        showKey(l1);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R1 = L0 XOR functionF(R0, Key1)"));
        r1 = xor(l0, functionF(r0, key1, 1));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R1 = L0 XOR functionF(R0, Key1), where functionF(R0, Key1) is R after Iteration 1 "));
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 2 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L2 = R1"));
        vBox.getChildren().add(new Label(" L2 is: "));
        l2 = r1;
        showKey(l2);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R2 = L1 XOR functionF(R1, Key2)"));
        r2 = xor(l1, functionF(r1, key2, 2));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R2 = L1 XOR functionF(R1, Key2), where functionF(R1, Key2) is R after Iteration 2 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L1 is:"));
        showKey(l1);
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 3 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L3 = R2"));
        vBox.getChildren().add(new Label(" L3 is: "));
        l3 = r2;
        showKey(l3);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R3 = L2 XOR functionF(R2, Key3)"));
        r3 = xor(l2, functionF(r2, key3, 3));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R3 = L2 XOR functionF(R2, Key3), where functionF(R2, Key3) is R after Iteration 3 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L2 is:"));
        showKey(l2);
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 4 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L4 = R3"));
        vBox.getChildren().add(new Label(" L4 is: "));
        l4 = r3;
        showKey(l4);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R4 = L3 XOR functionF(R3, Key4)"));
        r4 = xor(l3, functionF(r3, key4, 4));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R4 = L3 XOR functionF(R3, Key4), where functionF(R3, Key4) is R after Iteration 4 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L3 is:"));
        showKey(l3);
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 5 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L5 = R4"));
        vBox.getChildren().add(new Label(" L5 is: "));
        l5 = r4;
        showKey(l5);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R5 = L4 XOR functionF(R4, Key5)"));
        r5 = xor(l4, functionF(r4, key5, 5));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R5 = L4 XOR functionF(R4, Key5), where functionF(R4, Key5) is R after Iteration 5 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L4 is:"));
        showKey(l4);
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 6 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L6 = R5"));
        vBox.getChildren().add(new Label(" L6 is: "));
        l6 = r5;
        showKey(l6);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R6 = L5 XOR functionF(R5, Key6)"));
        r6 = xor(l5, functionF(r5, key6, 6));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R6 = L5 XOR functionF(R5, Key6), where functionF(R5, Key6) is R after Iteration 6 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L5 is:"));
        showKey(l5);
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 7 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L7 = R6"));
        vBox.getChildren().add(new Label(" L7 is: "));
        l7 = r6;
        showKey(l7);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R7 = L6 XOR functionF(R6, Key7)"));
        r7 = xor(l6, functionF(r6, key7, 7));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R7 = L6 XOR functionF(R6, Key7), where functionF(R6, Key7) is R after Iteration 7 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L6 is:"));
        showKey(l6);
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 8 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L8 = R7"));
        vBox.getChildren().add(new Label(" L8 is: "));
        l8 = r7;
        showKey(l8);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R8 = L7 XOR functionF(R7, Key8)"));
        r8 = xor(l7, functionF(r7, key8, 8));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R8 = L7 XOR functionF(R7, Key8), where functionF(R7, Key8) is R after Iteration 8 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L7 is:"));
        showKey(l7);
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 9 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L9 = R8"));
        vBox.getChildren().add(new Label(" L9 is: "));
        l9 = r8;
        showKey(l9);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R9 = L8 XOR functionF(R8, Key9)"));
        r9 = xor(l8,functionF(r8, key9, 9));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R9 = L8 XOR functionF(R8, Key9), where functionF(R8, Key9) is R after Iteration 9 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L8 is:"));
        showKey(l8);
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L10 = R9"));
        vBox.getChildren().add(new Label(" L10 is: "));
        l10 = r9;
        showKey(l10);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R10 = L9 XOR functionF(R9, Key10)"));
        r10 = xor(l9, functionF(r9, key10, 10));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R10 = L9 XOR functionF(R9, Key10), where functionF(R9, Key10) is R after Iteration 10 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L9 is:"));
        showKey(l9);
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 11 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L11 = R10"));
        vBox.getChildren().add(new Label(" L11 is: "));
        l11 = r10;
        showKey(l11);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R11 = L10 XOR functionF(R10, Key11)"));
        r11 = xor(l10, functionF(r10, key11, 11));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R11 = L10 XOR functionF(R10, Key11), where functionF(R10, Key11) is R after Iteration 11 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L10 is:"));
        showKey(l10);
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 12 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L12 = R11"));
        vBox.getChildren().add(new Label(" L12 is: "));
        l12 = r11;
        showKey(l12);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R12 = L11 XOR functionF(R11, Key12)"));
        r12 = xor(l11, functionF(r11, key12, 12));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R12 = L11 XOR functionF(R11, Key12), where functionF(R11, Key12) is R after Iteration 12 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L11 is:"));
        showKey(l11);
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 13 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L13 = R12"));
        vBox.getChildren().add(new Label(" L13 is: "));
        l13 = r12;
        showKey(l13);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R13 = L12 XOR functionF(R12, Key13)"));
        r13 = xor(l12, functionF(r12, key13, 13));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R13 = L12 XOR functionF(R12, Key13), where functionF(R12, Key13) is R after Iteration 13 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L12 is:"));
        showKey(l12);
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 14 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L14 = R13"));
        vBox.getChildren().add(new Label(" L14 is: "));
        l14 = r13;
        showKey(l14);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R14 = L13 XOR functionF(R13, Key14)"));
        r14 = xor(l13, functionF(r13, key14, 14));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R14 = L13 XOR functionF(R13, Key14), where functionF(R13, Key14) is R after Iteration 14 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L13 is:"));
        showKey(l13);
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 15 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L15 = R14"));
        vBox.getChildren().add(new Label(" L15 is: "));
        l15 = r14;
        showKey(l15);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R15 = L14 XOR functionF(R14, Key15)"));
        r15 = xor(l14, functionF(r14, key15, 15));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R15 = L14 XOR functionF(R14, Key15), where functionF(R14, Key15) is R after Iteration 15 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L14 is:"));
        showKey(l14);
        vBox.getChildren().add(new Label(""));
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" ROUND 16 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L16 = R15"));
        vBox.getChildren().add(new Label(" L16 is: "));
        l16 = r15;
        showKey(l16);

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" R16 = L15 XOR functionF(R15, Key16)"));
        r16 = xor(l15, functionF(r15, key16, 16));

        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" Now we calculate R16 = L15 XOR functionF(R15, Key16), where functionF(R15, Key16) is R after Iteration 16 "));
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label(" L15 is:"));
        showKey(l15);
        vBox.getChildren().add(new Label(""));
    ...
    public void getL0R0(){
        divideMessageInTwo(l0, r0, messageAfterIP);

        showL0R0();
    }

    public void showL0R0(){
        vBox.getChildren().add(new Label(""));
        String line = " L0 = ";
    ...
    public void getMessageAfterIP(){
        char[] messageChars = new char[64];
        ...
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
                messageAfterIP[k] = messageChars[matrixIP[i][j] - 1];
                k++;
            }
        }
        showMessageAfterIP();
