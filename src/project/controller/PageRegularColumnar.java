...
public class PageRegularColumnar {
        ...
        try{
            ...
            if (!(message.matches("[a-zA-Z0-9 ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[a-zA-Z0-9 ]+$"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageRegularColumnarEncryption.fxml"));
                    Parent root = loader.load();

                    PageRegularColumnarEncryption pageRegularColumnarEncryption = loader.getController();
                    pageRegularColumnarEncryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("Regular Columnar Transposition Cipher Encryption");
        ...
        try {
            ...
            if (!(message.matches("[a-zA-Z0-9 ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[a-zA-Z0-9 ]+$"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageRegularColumnarDecryption.fxml"));
                    Parent root = loader.load();

                    PageRegularColumnarDecryption pageRegularColumnarDecryption = loader.getController();
                    pageRegularColumnarDecryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("Regular Columnar Transposition Cipher Decryption");
                    primaryStage.setScene(scene);
                    primaryStage.show();
                }
            }
