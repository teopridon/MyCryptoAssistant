...
public class PageAffineDecryption {
    ...
    public void Encrypt(){
        ...
        vBox.getChildren().add(new Label(""));
        vBox.getChildren().add(new Label("Step2: For each of the number x, from above we calculate: (a^(-1))*(x-b) mod 26"));
        vBox.getChildren().add(new Label(""));
        ...
        for (int i = 0; i < message.length() ; i++) {
            for (int j = 0; j < 26; j++) {
                if (message.charAt(i)==englishAlphabet[j]){
                    ...
                    if (aInverted * ((j - key[1]))%26 < 0){

                        vBox.getChildren().add(new Label(" For number  " + j + ":    (" + aInverted + " * (" + j + " - " + key[1] + ")) mod 26 = " + (26 + (aInverted * (j - key[1]))%26)));

                    }else{

                        vBox.getChildren().add(new Label(" For number  " + j + ":    (" + aInverted + " * (" + j + " - " + key[1] + ")) mod 26 = " + (aInverted * (j - key[1]))%26));
                    }
            ...
            for (int j = 0; j < 26; j++) {
                if (message.charAt(i)==englishAlphabet[j]){
                    ...
                    if (aInverted * ((j - key[1]))%26 < 0){
                        ...
                        vBox.getChildren().add(new Label(" For position  " + (26 + (aInverted * (j - key[1]))%26) + "  we find letter:   " + englishAlphabet[(26 + (aInverted * (j - key[1]))%26)]));
                        result= result + englishAlphabet[(26 + (aInverted * (j - key[1]))%26)];

                    }else{
                        vBox.getChildren().add(new Label(" For position  " + (aInverted * (j - key[1]))%26 + "  we find letter:   " + englishAlphabet[(aInverted * (j - key[1]))%26]));
                        result= result + englishAlphabet[(aInverted * (j - key[1]))%26];
                    }
