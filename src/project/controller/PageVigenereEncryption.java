...
public class PageVigenereEncryption {
    ...
    public void Encrypt(){
        ...
        for (int i = 0; i < message.length() ; i++) {
            ...
            vBox.getChildren().add(new Label(" For letter  " + message.charAt(i) + "  we get from the table, on column " + column + " (corresponding to letter " + message.charAt(i) + " from the message) and the row " + row + " (corresponding to the letter " + key.charAt(i) + " from key),  letter:  " + tabulaRecta[row][column]));
