...
public class PageDoubleColumnar {
    @FXML
    ...
    public void Encrypt(){
        try{
            ...
            if (!(message.matches("[a-zA-Z0-9 ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[a-zA-Z0-9 ]+$"))){
                    keyLabel.setText("Please insert a key that contains only letters, numbers and white spaces.");
                }else {
                    key = transformToUppercase(key);

                    if (!(keyTextField1.getText().matches("[a-zA-Z0-9 ]+$"))){
                        keyLabel1.setText("Please insert a key that contains only letters, numbers and white spaces.");
                    }else {
                        key1 = transformToUppercase(key1);

                        FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageDoubleColumnarEncryption.fxml"));
                        Parent root = loader.load();

                        PageDoubleColumnarEncryption pageDoubleColumnarEncryption = loader.getController();
                        pageDoubleColumnarEncryption.transferMessage(message, key, key1);


                        Stage primaryStage = new Stage();
                        Scene scene = new Scene(root, 775, 430);
                        primaryStage.setTitle("Double Columnar Transposition Cipher Encryption");
            ...
            if (!(message.matches("[a-zA-Z0-9 ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[a-zA-Z0-9 ]+$"))){
                    ...
                    if (!(keyTextField1.getText().matches("[a-zA-Z0-9 ]+$"))){
                        ...
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageDoubleColumnarDecryption.fxml"));
                        Parent root = loader.load();

                        PageDoubleColumnarDecryption pageDoubleColumnarDecryption = loader.getController();
                        pageDoubleColumnarDecryption.transferMessage(message, key, key1);


                        Stage primaryStage = new Stage();
                        Scene scene = new Scene(root, 775, 430);
                        primaryStage.setTitle("Double Columnar Transposition Cipher Decryption");
                        primaryStage.setScene(scene);
                        primaryStage.show();}
                }
            }
