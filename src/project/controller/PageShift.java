        ...
        try{
            ...
            if (!(message.matches("[a-zA-Z ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[0-9]+"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageShiftEncryption.fxml"));
                    Parent root = loader.load();

                    PageShiftEncryption pageShiftEncryption = loader.getController();
                    pageShiftEncryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("Shift Cipher Encryption");
        ...
        try {
            ...
            if (!(message.matches("[a-zA-Z ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[0-9]+"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageShiftDecryption.fxml"));
                    Parent root = loader.load();

                    PageShiftDecryption pageShiftDecryption = loader.getController();
                    pageShiftDecryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("Shift Cipher Decryption");
                    primaryStage.setScene(scene);
                    primaryStage.show();
                }
            }
