        ...
        try{
            ...
            if (!(message.matches("[0-9a-zA-Z ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[0-9]+"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageRailFenceEncryption.fxml"));
                    Parent root = loader.load();

                    PageRailFenceEncryption pageRailFenceEncryption = loader.getController();
                    pageRailFenceEncryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("Rail-Fence Cipher Encryption");
        ...
        try {
            ...
            if (!(message.matches("[0-9a-zA-Z ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[0-9]+"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageRailFenceDecryption.fxml"));
                    Parent root = loader.load();

                    PageRailFenceDecryption pageRailFenceDecryption = loader.getController();
                    pageRailFenceDecryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("Rail-Fence Cipher Decryption");
                    primaryStage.setScene(scene);
                    primaryStage.show();
                }
            }
