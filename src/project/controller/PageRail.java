        ...
        try{
            ...
            if (!(message.matches("[0-9a-zA-Z ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[0-9]+"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageRailEncryption.fxml"));
                    Parent root = loader.load();

                    PageRailEncryption pageRailEncryption = loader.getController();
                    pageRailEncryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("Rail Cipher Encryption");
        ...
        try {
            ...
            if (!(message.matches("[0-9a-zA-Z ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[0-9]+"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageRailDecryption.fxml"));
                    Parent root = loader.load();

                    PageRailDecryption pageRailDecryption = loader.getController();
                    pageRailDecryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("Rail Cipher Decryption");
                    primaryStage.setScene(scene);
                    primaryStage.show();
                }
            }
