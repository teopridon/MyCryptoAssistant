        ...
        try{
            ...
            if (!(message.matches("[a-zA-Z ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[a-zA-Z ]+$"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pagePortaEncryption.fxml"));
                    Parent root = loader.load();

                    PagePortaEncryption pagePortaEncryption = loader.getController();
                    pagePortaEncryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("Porta Cipher Encryption");
        ...
        try {
            ...
            if (!(message.matches("[a-zA-Z ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[a-zA-Z ]+$"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pagePortaDecryption.fxml"));
                    Parent root = loader.load();

                    PagePortaDecryption pagePortaDecryption = loader.getController();
                    pagePortaDecryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("Porta Cipher Decryption");
                    primaryStage.setScene(scene);
                    primaryStage.show();
                }
            }
