        ...
        try{
            ...
            if (!(message.matches("[a-zA-Z ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[a-zA-Z ]+$"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageAbcEncryption.fxml"));
                    Parent root = loader.load();

                    PageAbcEncryption pageAbcEncryption = loader.getController();
                    pageAbcEncryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("ABC Cipher Encryption");
        ...
        try {
            ...
            if (!(message.matches("[a-zA-Z ]+$"))){
                ...
                if (!(keyTextField.getText().matches("[a-zA-Z ]+$"))){
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/project/views/pageAbcDecryption.fxml"));
                    Parent root = loader.load();

                    PageAbcDecryption pageAbcDecryption = loader.getController();
                    pageAbcDecryption.transferMessage(message, key);


                    Stage primaryStage = new Stage();
                    Scene scene = new Scene(root, 775, 430);
                    primaryStage.setTitle("ABC Cipher Decryption");
                    primaryStage.setScene(scene);
                    primaryStage.show();
                }
            }
